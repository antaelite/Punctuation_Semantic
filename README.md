...
### 4. Main Job (`src/main/java/org/example/`)
...
- Tucker, P. A., Maier, D., Sheard, T., & Fegaras, L. (2003). Exploiting punctuation semantics in continuous data streams. _IEEE Transactions on Knowledge and Data Engineering_, 15(3), 555-568.
